...
namespace Helpers
{
	...
	void Camera::Initialise(const glm::vec3& startPos, const glm::vec3& startRots, float translationPerSecond, float rotationPerSecond)
	{
		...
		std::cout << "Up and Down arrows - moves the light up and down the Y axis." << std::endl;
		std::cout << "Left and Right arrows - moves the light along the x and z axis" << std::endl;
